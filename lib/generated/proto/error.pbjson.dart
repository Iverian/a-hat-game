...
const ErrorCode$json = {
  ...
  '2': [
    ...
    {'1': 'INVALID_LOBBY_CODE', '2': 7},
  ],
};

/// Descriptor for `ErrorCode`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List errorCodeDescriptor = $convert.base64Decode(
    'CglFcnJvckNvZGUSCQoFT1RIRVIQABIUChBNSVNTSU5HX01FVEFEQVRBEAESEgoORUFSTFlfUkVWSVNJT04QAhIUChBJTlZBTElEX1JFVklTSU9OEAMSFQoRUExBWUVSX05BTUVfVEFLRU4QBBIUChBQTEFZRVJfTk9UX0ZPVU5EEAUSGgoWSU5WQUxJRF9DSEFSQUNURVJfREFUQRAGEhYKEklOVkFMSURfTE9CQllfQ09ERRAH');
