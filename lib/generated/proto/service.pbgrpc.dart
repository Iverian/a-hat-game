...
class JoinClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.LobbyJoinResponse> lobbyJoin($0.LobbyJoinRequest request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$lobbyJoin, request, options: options);
}
...
abstract class JoinServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.LobbyJoinResponse> lobbyJoin_Pre(
      $grpc.ServiceCall call, $async.Future<$0.LobbyJoinRequest> request,) async => lobbyJoin(call, await request);
...
class GameClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$0.GameEvent> subscribe($1.Empty request, {$grpc.CallOptions? options}) => $createStreamingCall(_$subscribe, $async.Stream.fromIterable([request]),
        options: options,);

  $grpc.ResponseFuture<$0.FallibleResponse> confirm($0.ConfirmRequest request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$confirm, request, options: options);

  $grpc.ResponseFuture<$0.FallibleResponse> heartbeat($1.Empty request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$heartbeat, request, options: options);

  $grpc.ResponseFuture<$0.FallibleResponse> lobbyLeave($1.Empty request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$lobbyLeave, request, options: options);

  $grpc.ResponseFuture<$0.FallibleResponse> lobbyPlayerReady($0.LobbyPlayerReadyRequest request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$lobbyPlayerReady, request, options: options);

  $grpc.ResponseFuture<$0.FallibleResponse> lobbyPlayerNotReady($1.Empty request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$lobbyPlayerNotReady, request, options: options);

  $grpc.ResponseFuture<$0.FallibleResponse> startTurn($1.Empty request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$startTurn, request, options: options);

  $grpc.ResponseFuture<$0.FallibleResponse> endTurn($0.EndTurnRequest request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$endTurn, request, options: options);

  $grpc.ResponseFuture<$0.FallibleResponse> castVote($0.CastVoteRequest request,
      {$grpc.CallOptions? options,}) => $createUnaryCall(_$castVote, request, options: options);
}
...
abstract class GameServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.FallibleResponse> confirm_Pre(
      $grpc.ServiceCall call, $async.Future<$0.ConfirmRequest> request,) async => confirm(call, await request);

  $async.Future<$0.FallibleResponse> heartbeat_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request,) async => heartbeat(call, await request);

  $async.Future<$0.FallibleResponse> lobbyLeave_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request,) async => lobbyLeave(call, await request);

  $async.Future<$0.FallibleResponse> lobbyPlayerReady_Pre(
      $grpc.ServiceCall call, $async.Future<$0.LobbyPlayerReadyRequest> request,) async => lobbyPlayerReady(call, await request);

  $async.Future<$0.FallibleResponse> lobbyPlayerNotReady_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request,) async => lobbyPlayerNotReady(call, await request);

  $async.Future<$0.FallibleResponse> startTurn_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request,) async => startTurn(call, await request);

  $async.Future<$0.FallibleResponse> endTurn_Pre(
      $grpc.ServiceCall call, $async.Future<$0.EndTurnRequest> request,) async => endTurn(call, await request);

  $async.Future<$0.FallibleResponse> castVote_Pre(
      $grpc.ServiceCall call, $async.Future<$0.CastVoteRequest> request,) async => castVote(call, await request);
